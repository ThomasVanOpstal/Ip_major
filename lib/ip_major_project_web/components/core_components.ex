defmodule IpMajorProjectWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(IpMajorProjectWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(IpMajorProjectWeb.Gettext, "errors", msg, opts)
    end
  end
